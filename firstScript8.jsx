{
    ...
    function uploadLogo() {
        ...
        if (file) {
            ...
            imageLayer.property("Position").setValue([50, 50]); // Set position to 50px from left and top
        }
    }
    ...
    function addImageLayer(imageFile, position, startTime, duration) {
        ...
        // Hold the opacity at 100 for the rest of the duration
    ...
    addTextButton.onClick = function() {
        ...
        if (uploadedImage1) {
            addImageLayer(uploadedImage1, [50, 250], 1, 4); // Adjust the start time and duration as needed
        }
        ...
        if (uploadedImage2) {
            addImageLayer(uploadedImage2, [50, 250], 6.5, 4); // Adjust the start time and duration as needed
        }
    };
